...
export const DocumentNode: React.FC<DocumentNodeProps> = ({ data }) => {
  return (
    <div className="bg-[#121212] border border-[#333] p-4 rounded-xl shadow-lg min-w-[150px] transition-all duration-300 hover:shadow-[0_0_15px_rgba(100,200,255,0.3)] hover:border-[#64c8ff]">

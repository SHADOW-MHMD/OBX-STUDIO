...
export const PersonaNode: React.FC<PersonaNodeProps> = ({ data }) => {
  return (
    <div className="bg-[#1e1e1e] border-2 border-purple-500/50 p-4 rounded-full shadow-lg min-w-[120px] h-[120px] flex flex-col items-center justify-center transition-all duration-300 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:border-purple-400">
